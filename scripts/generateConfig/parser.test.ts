  ...
  const inputPool = [
    {
      ...
      description:
        'BLINk enables ETH holders to enjoy gaming experiences that WINk users on Tron have been enjoying for over two years.',
      project_url: 'https://blink.wink.org',
      currency: 'OVEN-ETH LP',
