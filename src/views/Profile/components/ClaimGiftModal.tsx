...
import { Modal, Text, InjectedModalProps, Button, AutoRenewIcon } from 'easybake-uikit'
  ...
  return (
    <Modal title={t('Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        <Text as="p">{t('Thank you for being a day-one user of EasyBake Profiles!')}</Text>
        <Text as="p" mb="8px">
        ...
        <Text as="p">{('To make it up to you, we’ll refund you the full 4 OVEN it cost to make your bunny.')}</Text>
        <Text as="p" mb="8px">
