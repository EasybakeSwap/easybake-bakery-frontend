  ...
  const handleHarvestConfirm = async () => {
    ...
    if (shouldCompound) {
      try {
        ...
        toastSuccess(
          `${('Compounded')}!`,
          ('Your %symbol% earnings have been re-invested into the pool!' + { symbol: earningToken.symbol }),
        )
        setPendingTx(false)
        onDismiss()
      } catch (e) {
      ...
      try {
        ...
        toastSuccess(
          `${('Harvested')}!`,
          ('Your %symbol% earnings have been sent to your wallet!' + { symbol: earningToken.symbol }),
        )
        setPendingTx(false)
        onDismiss()
      } catch (e) {
