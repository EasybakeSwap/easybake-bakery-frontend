...
import { Button, IconButton, useModal, AddIcon, Image } from 'easybakeswap-uikit'
...
import OldSugarTitle from './OldSugarTitle'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  const isOldSugar = stakingTokenName === QuoteToken.SUGAR
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        {!isOldSugar ? (
          ...
          <OldSugarTitle hasBalance={accountHasStakedBalance} />
        )}
        ...
        <StyledDetails>
          ...
          {isFinished || isOldSugar || !apy || apy?.isNaN() || !apy?.isFinite() ? (
            '-'
          ) : (
