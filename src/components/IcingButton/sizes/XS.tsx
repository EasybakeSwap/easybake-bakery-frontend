...
const spinDownOn = keyframes`{
  ...
  100% {
    transform: translateX(0%) translateY(-10%) rotate(390deg);
  }
}`;
...
const spinDownOff = keyframes`{
  ...
  100% {
    transform: translateX(-10%) translateY(100%) rotate(780deg);
  }
}`;
...
const IcingButtonXS: React.FC<ButtonType> = ({
  btnName,
  isLoading,
  isDisabled,
  onClick,
...
const BaseButtonXS: React.FC<ButtonType> = ({
  btnName,
  isLoading,
  isDisabled,
  onClick,
...
export { IcingButtonXS, BaseButtonXS };